...
struct pommel: weaponComponent {
    ...
    var simpleDescription: String {return "\(self.cMaterial.rawMaterial.name) \(self.componentType.name) Pommel\((self.hasGem || self.hasEtching ? " with ": ""))\(self.hasGem ? "inlaid \(self.componentGemstone!.rawMaterial.name)" : "")\((self.hasGem && self.hasEtching ? " and " : ""))\((self.hasEtching ? self.componentEtching!.etchingType.name : ""))"}
}
...
struct handle: weaponComponent, handleComponent {
    ...
    var simpleDescription: String {return "\(self.hasWrap ? "\(self.wrapType!.name) \(self.wrap!.rawMaterial.name)\(self.wrap! as? fabric != nil ? " Cord" : "") Handle" : "\(self.cMaterial.rawMaterial.name) Handle\(self.hasEtching ? " with \(self.componentEtching!.etchingType.name)" : "")")"}
}
...
struct crossguard: weaponComponent {
    ...
    var simpleDescription: String {return "\(self.cMaterial.rawMaterial.name) \(self.guardShape.name) Guard\((self.hasGem || self.hasEtching ? " with ": ""))\(self.hasGem ? "inlaid \(self.componentGemstone!.rawMaterial.name)" : "")\((self.hasGem && self.hasEtching ? " and " : ""))\((self.hasEtching ? self.componentEtching!.etchingType.name : ""))"}
...
struct blade: weaponComponent, bladedComponent {
    ...
    var simpleDescription: String {return "\(self.length)\" \(self.componentType.name) \(self.isDoubleEdge ? "Double-Edged" : "Single-Edged") \(self.cMaterial.rawMaterial.name) Blade\(self.withFuller ? " with a \(self.fuller!.name) Fuller" : "")\(self.hasEtching ? " with \(self.componentEtching!.etchingType.name)" : "")"}
}
...
struct haft: weaponComponent, handleComponent {
    ...
    var simpleDescription: String {return "\(self.length)\" \(self.cMaterial.rawMaterial.name) Haft\(self.hasEtching ? " with \(self.componentEtching!.etchingType.name)" : "")"}
...
struct axeHead: weaponComponent, bladedComponent {
    ...
    var simpleDescription: String {return "\(self.componentType.name) \(self.cMaterial.rawMaterial.name)\(self.hasDoubleHead ? " Double" : "") Axe Head\(self.hasEtching ? " with \(self.componentEtching!.etchingType.name)" : "")"}
}
...
struct maceHead: weaponComponent {
    ...
    var simpleDescription: String {return "\(self.componentType.name) \(self.cMaterial.rawMaterial.name) Mace Head\(self.hasEtching ? " with \(self.componentEtching!.etchingType.name)" : "")"}
}
